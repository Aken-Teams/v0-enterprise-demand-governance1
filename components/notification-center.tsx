            ...
            {loading ? (
              ...
              notifications.map((n) => {
                ...
                return (
                  ...
                  >
                    <div className={cn("rounded-full p-1.5 shrink-0", typeInfo.bg)}>
                      <Icon className={cn("h-3.5 w-3.5", typeInfo.color)} />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline gap-2">
                        <span className={cn("text-sm truncate", !n.isRead ? "font-semibold" : "text-muted-foreground")}>
                          {n.title}
                        </span>
                    ...
                    <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        className="rounded p-1 text-muted-foreground/50 hover:text-red-500 hover:bg-red-50 transition-colors"
                        title="刪除"
      ...
      <AlertDialog open={!!confirmDeleteId} onOpenChange={(o) => { if (!o) setConfirmDeleteId(null) }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>確定要刪除這則通知嗎？</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
